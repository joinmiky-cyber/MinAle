...
SECRET_KEY = env('SECRET_KEY', default='django-insecure-minale-app-secret-key-12345')
...
ROOT_URLCONF = 'minale_backend.urls'
...
WSGI_APPLICATION = 'minale_backend.wsgi.application'
